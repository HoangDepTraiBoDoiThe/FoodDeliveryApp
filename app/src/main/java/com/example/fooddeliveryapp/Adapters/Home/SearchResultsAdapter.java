...
import com.example.fooddeliveryapp.ui.favourite.Fragment.FirstFragment;
import com.example.fooddeliveryapp.ui.favourite.Fragment.SecondFragment;
...
public class SearchResultsAdapter extends RecyclerView.Adapter<SearchResultsAdapter.ViewHolder>{
    ...
    public SearchResultsAdapter(Context context, ArrayList<HomeVerModel> homeVerModels) {
    ...
    @NotNull
    @Override
    public SearchResultsAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        return new SearchResultsAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.home_vertical_item, parent, false));
    }
    ...
    private void fetchUserFavoritesFromServer(String foodID, HomeVerAdapter.OnFetchFavoritesListener listener) {
        DatabaseReference favoritesRef = FirebaseDatabase.getInstance().getReference("users")
                .child(hardcodedUserID).child("favorites");
